...
| `calendar.html` | Calendar: weekly offerings and a filterable list of upcoming events |
...
| `support.html` | Support: the economic model, sliding scale, scholarships, work-trade, giving |
...
- **Physical details** that are plausible but not confirmed: bathrooms a short walk from the yurts, a phone at the House, gravel road, number of yurts.
